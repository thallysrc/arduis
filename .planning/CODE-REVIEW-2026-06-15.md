...
| 5 | `window._on_close_request` SIGKILL via `GLib.timeout_add` — the 1500ms timer never fires after the window closes (main loop ends); processes that ignore SIGHUP orphan | High | **DEFERRED — UX timing tradeoff** |
